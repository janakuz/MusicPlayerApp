...
import com.example.musicapp.ui.viewmodels.MoodDetailViewModel
...
fun MoodDetailScreen(
    ...
    val moodDetailViewModel: MoodDetailViewModel = hiltViewModel()
    val results by moodDetailViewModel.moodItems.collectAsState()
    val name by moodDetailViewModel.moodName.collectAsState()
