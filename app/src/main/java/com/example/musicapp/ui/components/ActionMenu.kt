...
fun ActionMenu(
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            MenuActionItem("Play Next", Icons.AutoMirrored.Filled.PlaylistPlay, actions.onPlayNext, onDismiss)
            MenuActionItem("Add to Queue", Icons.Default.Queue, actions.onAddToQueue, onDismiss)
            MenuActionItem("Remove from Queue", Icons.Default.Remove, actions.onRemoveFromQueue, onDismiss)
            MenuActionItem("Add to Playlist", Icons.AutoMirrored.Filled.PlaylistAdd, actions.onAddToPlaylist, onDismiss)
            MenuActionItem("Remove from Playlist", Icons.Default.PlaylistRemove, actions.onRemoveFromPlaylist, onDismiss)
            ...
            if (actions.onEdit != null || actions.onRefetchMetadata != null || actions.onExportM3u != null || actions.onMoveToAlbum != null) {
                ...
                MenuActionItem("Move to Album", Icons.AutoMirrored.Filled.DriveFileMove, actions.onMoveToAlbum, onDismiss)
            }
